...
import { Home, Calendar, Settings, Wrench, Sparkles } from "lucide-react";
	...
	return (
		<div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50">
			<div
				ref={containerRef}
				className={cn(
					"relative border rounded-2xl shadow-xl p-0 overflow-visible bg-background border-border/50",
				)}
			>
				...
				<AnimatePresence>
					{hoveredItem && hoveredItem.shortcut && (
						<motion.div
							key="tooltip"
							className="absolute -top-12 left-0 flex items-center gap-2 px-3 py-1.5 bg-popover border border-border/50 rounded-lg shadow-xl whitespace-nowrap z-50 pointer-events-none overflow-hidden"
							initial={{
								opacity: 0,
								y: 10,
								scale: 0.95,
						...
						>
							<AnimatePresence mode="popLayout" initial={false}>
								...
								>
									...
									<span className="text-xs font-medium text-foreground bg-accent/50 px-2 py-0.5 rounded">
