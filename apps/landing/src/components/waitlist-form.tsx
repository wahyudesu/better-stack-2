  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      try {
        ...
        // Response was not valid JSON - server returned error page or empty body
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent onEscapeKeyDown={handleCloseDialog}>
          <DialogHeader>
            ...
            <DialogDescription>
              Thanks for your interest! We'll send you an email once your access is ready.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter showCloseButton>
            <DepthButton variant="blue" onClick={handleCloseDialog}>
              Got it!
            </DepthButton>
          </DialogFooter>
        </DialogContent>
