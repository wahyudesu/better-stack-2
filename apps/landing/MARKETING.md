...
- Actionable analytics. Data yang langsung bisa dipakai untuk optimasi konten, engagement, dan growth.

## main feature
- Publish — kelola dan jadwalkan konten.
- Collaborate — approval workflow, client review, team role.
- Engage — inbox, komentar, DM, response management.
- Measure — analytics, reporting, performance tracking.
- Automate — koneksi akun, webhook, workflow automation.
...
# all feature
- Brand inbox
Untuk mengelola DM, komentar, dan interaksi audience.
- Ads Campaign Boosting
Untuk membantu aktivasi promosi berbayar.
- Performance Analytics
Untuk tracking performa konten dan campaign.
- Multi-Channel Publishing
posting ke lebih dari 14+ social media
- sentiment analysis
analisis komentar
- Performance Analytics
Untuk tracking performa konten dan campaign. 
- Social CRM
simpan dan kelola kontak dari berbagai social media
- AI analytics assistant
Tanya AI untuk ringkasan performa, trend detection, dan rekomendasi konten.
- AI Agent support
MCP support untuk integrasi dengan AI agent, OpenClaw, dan workflow automation.

## Key Brand Messages
- "From idea to published post – across 14+ platforms – in one clean workspace."
- "See all your comments, DMs, and reviews in one inbox, not ten tabs."
- "Know which posts actually grow your brand – with clear analytics, not guesswork."
- "Post with confidence: schedule at the right time, on the right channel, with insights from your own data."

## tone of voice
Friendly but data-driven. Like a helpful teammate who gets both the creative side and the numbers.
Clear, not clever. No jargon. Say what it does, say what users get.
Outcome-first. Lead with what they achieve — consistency, clarity, growth, time saved.
Global-ready. English copy built to translate cleanly into Bahasa Indonesia.

## primary audience
- Product teams and startups that want data-driven social media decisions.
- Content creators, solo founders, and marketers who manage multiple social channels.
